...
The plugin creates a preserved sample project, six screenshots, a validated Markdown guide, and run metadata under `artifacts/<organization>-<package>/` in the repository where Codex is running. It does not publish, commit, deploy, or create pull requests.
